...
\label{State-of-the-Art}
	...
	Mit der Wirkleistung allein ist man jedoch nicht in der Lage Ger"ate mit sehr "ahnlichem Verbrauch zu unterscheiden, ein Beispiel w"aren hier ein 2kW Motor und ein 2kW Heizelement. 
	 ...
	 Dabei werden die Wellenformen und die harmonischen Komponenten des Frequenzspektrums verwendet, um Verbraucher zu unterscheiden. Laughman \cite{laughman2003power} zeigt z.B., dass sich Glühbirne und Netzteil in der 3. harmonischen Komponente deutlich unterscheiden.
	 ...
	 Micro level Features bieten sehr gute Unterscheidungsm"oglichkeiten, ben"otigen aber auch ein sehr hochfrequent aufgel"ostes Signal, "ublich sind mehrere kHz. Anderson  \cite{anderson2012blued} bietet einen Datensatz mit 12kHz Aufl"osung. \\
