...
\label{State-of-the-Art}
	...
	Mit der Wirkleistung allein ist man jedoch nicht in der Lage Ger"ate mit sehr "ahnlichem Verbrauch zu unterscheiden, ein Beispiel w"aren hier ein 2kW Motor und ein 2kW Heizelement.\\
	 ...
	 Hier werden Wellenformen und die harmonischen Komponenten des Frequenzspektrums verwendet um Verbraucher zu unterscheiden, \cite{laughman2003power} zeigt hier z.B., dass sich Glühbirne und Netzteil in der 3. harmonischen Komponente deutlich unterscheiden.
	 Zus"atzlich ver"andern viele Ger"ate die Wellenform des Stroms, so dass hier weiteres Potential für die Unterscheidung verschiedener Ger"ate vorliegt \cite{liang2010load}. \\ %TODO evtl Grafik Spektrum/Wellenform
